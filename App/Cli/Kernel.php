...
use App\Cli\Commands\{CommandInterface, Cron\RunCron, HelloWorld, OAuth\GenerateKey, Queue\StartConsumer};
...
final class Kernel
{
    ...
    private function printCopyright(): void
    {
        ...
        $this->cli->tab()->bold('<white>SiteworxPro Micro Service</white>');
